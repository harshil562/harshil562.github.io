...
/***/ function(module, exports, __webpack_require__) {
	...
	var _quizQuestionListJs = __webpack_require__(160);

	var _quizQuestionListJs2 = _interopRequireDefault(_quizQuestionListJs);

	var _quizScoreboxJs = __webpack_require__(162);
						...
						_createClass(App, [{
											...
											value: function render() {
																...
																if (this.state.current > this.state.questions.length) {
																					...
																					var scorebox = '';
																					var results = _react2['default'].createElement(_quizResultsJs2['default'], this.state);
																} else {

																					var scorebox = _react2['default'].createElement(_quizScoreboxJs2['default'], this.state);
																					var results = '';
																}
																return(
																					...
																					_react2['default'].createElement(
																										...
																										null,
																										scorebox,
																										_react2['default'].createElement(_quizQuestionListJs2['default'], _extends({}, this.state, { setCurrent: this.setCurrent.bind(this), setScore: this.setScore.bind(this) })),
																										results
																					)
																);
											}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QuestionJs = __webpack_require__(161);
				...
				return _react2['default'].createElement(
					...
					this.props.questions.map(function (question) {
						if (question.id == _this.props.current) {
							return _react2['default'].createElement(_QuestionJs2['default'], _extends({ question: question, key: question.id }, _this.props));
						}
					})
				);
			}
